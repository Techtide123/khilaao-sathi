      ...
      <div className="flex w-full items-center justify-center p-3 md:p-10 min-h-[95vh] overflow-hidden bg-gradient-to-b from-[#ede9fe] via-white to-[#f8fafc] ">
        <div className="w-full max-w-4xl">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="grid gap-3">
                    <div className="flex items-center">
                      ...
                      <Link
                        href="/reset"
                        className="ml-auto text-sm underline-offset-2 hover:underline text-[#580FC2]"
                      >
                  ...
                  <Button type="submit" className="w-full bg-[#580FC2] hover:bg-[#4c0aae] text-white" onClick={handleLogin}>
                    Login
                  </Button>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <Button variant="outline" type="button" className="w-full border-[#580FC2] text-[#580FC2] hover:bg-[#580FC2]/10" onClick={handleGoogleLogin}>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
                  ...
                  <div className="text-center text-sm">
                    ...
                    <Link href="/signup" className="underline underline-offset-4 text-[#580FC2]">
                      Sign up
                    </Link>
                  </div>
                </div>
          ...
          <div className="text-muted-foreground text-center text-xs text-balance">
            By clicking continue, you agree to our <Link href="#" className="text-[#580FC2] hover:underline">Terms of Service</Link> and <Link href="#" className="text-[#580FC2] hover:underline">Privacy Policy</Link>.
          </div>
