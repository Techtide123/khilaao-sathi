...
export default function LoginPage() {
  ...
  return (
    <>
      <div className="flex w-full items-center justify-center p-6 md:p-10 min-h-[95vh] overflow-hidden">
        <div className="w-full max-w-4xl">
          ...
          <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4 sm:mt-1">
